   ...
   <div class="row mt">
      <div class="col-lg-12">	
		...
		<div class="form-panel" style="display:none">
			...
			<form class="form-horizontal style-form" id="user-form" method="POST" action="<?php echo base_url() . 'data/user/simpan' ?>">
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">					
						<input class="form-control round-form" type="text" id="txt_username" name="username" autocomplete="off">
         ...
         <div class="content-panel">
			<button type="button" style="margin-right: 10px" class="btn btn-info pull-right" id="btn-tambah-user">Tambah Data</button>
